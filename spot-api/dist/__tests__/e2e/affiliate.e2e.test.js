...
describe('Affiliate API E2E', () => {
    ...
    describe('GET /api/v1/affiliate/code', () => {
        it('should return 400 without address', async () => {
            const res = await (0, supertest_1.default)(testApp_1.default).get('/api/v1/affiliate/code');
            expect(res.status).toBe(400);
            expect(res.body).toHaveProperty('error', 'address required');
        });
        it('should return code and link with valid address', async () => {
            const res = await (0, supertest_1.default)(testApp_1.default).get('/api/v1/affiliate/code?address=test-addr-123');
    ...
    describe('GET /api/v1/affiliate/dashboard', () => {
        it('should return 400 without address', async () => {
            const res = await (0, supertest_1.default)(testApp_1.default).get('/api/v1/affiliate/dashboard');
            expect(res.status).toBe(400);
            expect(res.body).toHaveProperty('error', 'address required');
        });
        it('should return dashboard data with valid address', async () => {
            const res = await (0, supertest_1.default)(testApp_1.default).get('/api/v1/affiliate/dashboard?address=test-addr');
            expect(res.status).toBe(200);
    ...
    describe('GET /api/v1/affiliate/tree', () => {
        it('should return 400 without address', async () => {
            const res = await (0, supertest_1.default)(testApp_1.default).get('/api/v1/affiliate/tree');
            expect(res.status).toBe(400);
            expect(res.body).toHaveProperty('error', 'address required');
        });
        it('should return empty tree for address without referrals', async () => {
            const res = await (0, supertest_1.default)(testApp_1.default).get('/api/v1/affiliate/tree?address=test-addr');
            expect(res.status).toBe(200);
    ...
    describe('GET /api/v1/affiliate/payouts', () => {
        it('should return 400 without address', async () => {
            const res = await (0, supertest_1.default)(testApp_1.default).get('/api/v1/affiliate/payouts');
            expect(res.status).toBe(400);
        });
        it('should return empty payouts list', async () => {
            const res = await (0, supertest_1.default)(testApp_1.default).get('/api/v1/affiliate/payouts?address=test-addr');
            expect(res.status).toBe(200);
    ...
    describe('POST /api/v1/affiliate/payout/process', () => {
        it('should process payout batch', async () => {
            const res = await (0, supertest_1.default)(testApp_1.default).post('/api/v1/affiliate/payout/process');
            expect(res.status).toBe(200);
...
//# sourceMappingURL=affiliate.e2e.test.js.map