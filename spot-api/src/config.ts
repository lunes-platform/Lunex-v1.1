...
export const config = {
  ...
  blockchain: {
    ...
    factoryContractMetadataPath: process.env.FACTORY_CONTRACT_METADATA_PATH || './abis/Factory.json',
  },
  ...
  subquery: {
    ...
    enabled: process.env.SUBQUERY_ENDPOINT ? process.env.SUBQUERY_ENABLED !== 'false' : false,
  },
