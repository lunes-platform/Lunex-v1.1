...
describe('Margin API E2E', () => {
    describe('GET /api/v1/margin', () => {
        ...
        it('should return 200 with valid address', async () => {
            const res = await request(app).get('/api/v1/margin?address=test-addr-123')
    ...
    describe('GET /api/v1/margin/price-health', () => {
        it('should return 200 without filters', async () => {
            const res = await request(app).get('/api/v1/margin/price-health')
        ...
        it('should return 200 with pair filter', async () => {
            const res = await request(app).get('/api/v1/margin/price-health?pairSymbol=LUNES/USDT')
        ...
        it('should return 400 on invalid pair filter', async () => {
            const res = await request(app).get('/api/v1/margin/price-health?pairSymbol=x')
    ...
    describe('POST /api/v1/margin/price-health/reset', () => {
        it('should return 200 without filters', async () => {
            const res = await request(app).post('/api/v1/margin/price-health/reset').send({})
        ...
        it('should return 200 with pair filter', async () => {
            const res = await request(app).post('/api/v1/margin/price-health/reset').send({ pairSymbol: 'LUNES/USDT' })
        ...
        it('should return 400 on invalid pair filter', async () => {
            const res = await request(app).post('/api/v1/margin/price-health/reset').send({ pairSymbol: 'x' })
