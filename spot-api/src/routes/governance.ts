...
const VoteCheckSchema = z.object({
 ...
 */
router.post('/vote/check', async (req: Request, res: Response, next: NextFunction) => {
    try {
 ...
 */
router.post('/vote/record', async (req: Request, res: Response, next: NextFunction) => {
    try {
 ...
 */
router.get('/vote/history', async (req: Request, res: Response, next: NextFunction) => {
    try {
