...
import {
  ...
  Github, Twitter, MessageCircle, Send, ArrowDown,
  BarChart3, Layers, Coins, Globe, Bot, Copy, BookOpen,
  TrendingUp, Activity, ChevronRight, Star, Lock, Target
} from 'lucide-react'
  ...
  return (
    <S.Page>
      <Helmet>
        ...
        <meta name="description" content="Swap, spot trade, deploy AI agents, copy top strategies, and earn rewards in a unified trading protocol built on the Lunes blockchain." />
      ...
      <S.HeroSection>
        <S.HeroTitle $delay="0.1s">
          Trade.<br />Automate.<br /><span>Scale.</span>
        </S.HeroTitle>
      ...
      <S.FlowSection id="how-it-works">
        <S.SectionLabel className="reveal-on-scroll">Protocol Architecture</S.SectionLabel>
        <S.STitle className="reveal-on-scroll">How Lunex <span>works</span></S.STitle>
        <S.SSub className="reveal-on-scroll">
          A unified on-chain execution layer where every trading mode feeds into the same liquidity and rewards system.
        </S.SSub>
        ...
        <S.FlowDiagram className="reveal-on-scroll">
          ...
          <S.FlowNodeGroup $side="right">
            <S.FlowNode $accent="#FF9500" style={{ transform: 'translateY(-10px)' }}>
              <Gift />
              <div className="content">
            ...
            <S.FlowNode $accent="#A0F0D0" style={{ transform: 'translateY(10px)' }}>
              <Coins />
              <div className="content">
                <span>Staking</span>
      ...
      <S.AsymSection id="asymmetric-liquidity">
        ...
        <S.AsymHeader className="reveal-on-scroll">
          ...
          <S.AsymSubtitle>
            Break free from symmetric bonding. Deploy capital inside precisely-defined
            asymmetric ranges to capture maximum fees during volatility — managed by humans
        ...
        <S.AsymGrid>
          <S.AsymContent>
            <S.AsymFeatureList>
              <S.AsymFeature className="reveal-on-scroll" $delay="0.1s" $accent="#00E5A0">
                <h4><Target size={18} color="#00E5A0" /> Hyper-Concentration</h4>
                <p>Deploy capital specifically where the volume happens. Concentrate your range inside tight 10% deviations to maximize fee capture per dollar.</p>
              </S.AsymFeature>
              <S.AsymFeature className="reveal-on-scroll" $delay="0.2s" $accent="#FFD700">
                <h4><Bot size={18} color="#FFD700" /> AI-Driven Boundaries</h4>
                <p>The LUNEX Agentic Swarm autonomously shifts your liquidity bands, predicting impermanent loss windows before market moves occur.</p>
              </S.AsymFeature>
              <S.AsymFeature className="reveal-on-scroll" $delay="0.3s" $accent="#FF3366">
                <h4><Zap size={18} color="#FF3366" /> Single-Sided Exposure</h4>
                <p>Provide liquidity without holding the paired asset. The protocol dynamically hedges your position using on-chain synthetic derivatives.</p>
              </S.AsymFeature>
            </S.AsymFeatureList>
          </S.AsymContent>
          ...
          <S.AsymChartWrap className="reveal-on-scroll" $delay="0.15s">
            ...
            <S.ChartLabels>
              <S.ChartLabel $color="#00E5A0">Concentrated&nbsp;Liquidity</S.ChartLabel>
              <S.ChartLabel $color="rgba(255,255,255,0.2)">Constant&nbsp;Product&nbsp;(xy=k)</S.ChartLabel>
            </S.ChartLabels>

            <S.AsymSVG viewBox="0 0 560 340" preserveAspectRatio="xMidYMid meet">
              <defs>
              ...
              {[130, 200, 270, 340, 410].map(x => (
                <line key={x} x1={x} y1="15" x2={x} y2="280" stroke="rgba(0,229,160,0.05)" strokeWidth="1" />
              ))}
              {[60, 120, 180, 240].map(y => (
                <line key={y} x1="60" y1={y} x2="540" y2={y} stroke="rgba(255,255,255,0.04)" strokeWidth="1" />
              ))}
              ...
              {/* Setas nos eixos */}
              <polygon points="540,276 548,280 540,284" fill="rgba(255,255,255,0.08)" />
              <polygon points="56,15 60,7 64,15" fill="rgba(255,255,255,0.08)" />

              {/* ── Labels eixo X ── */}
              <text x="130" y="296" className="svg-label" textAnchor="middle">0.85</text>
              <text x="200" y="296" className="svg-label" textAnchor="middle">0.92</text>
              <text x="270" y="296" className="svg-label" textAnchor="middle" style={{fill:'rgba(0,229,160,0.6)'}}>1.00</text>
              <text x="340" y="296" className="svg-label" textAnchor="middle">1.08</text>
              <text x="410" y="296" className="svg-label" textAnchor="middle">1.15</text>
              <text x="300" y="316" className="svg-label" textAnchor="middle" style={{letterSpacing:'2px', fontSize:'9px'}}>PRICE RATIO</text>

              {/* ── Labels eixo Y ── */}
              <text x="52" y="65"  className="svg-label" textAnchor="end">High</text>
              <text x="52" y="175" className="svg-label" textAnchor="end">Mid</text>
              <text x="52" y="278" className="svg-label" textAnchor="end">Low</text>
              <text x="18" y="160" className="svg-label" textAnchor="middle" transform="rotate(-90,18,160)" style={{letterSpacing:'2px', fontSize:'9px'}}>LIQUIDITY</text>

              {/* ── Zona AI Range ── */}
              <rect x="225" y="20" width="120" height="260" rx="2" className="ai-zone" />
              {/* Linha Superior da zona */}
              <line x1="225" y1="20" x2="345" y2="20" stroke="rgba(0,229,160,0.3)" strokeWidth="1" strokeDasharray="4 2" />
              {/* Movido para a esquerda para não colidir com Current Price */}
              <text x="260" y="32" className="svg-label-green" textAnchor="end" fontSize="9" letterSpacing="1.5">AI RANGE</text>
              ...
              <line x1="270" y1="44" x2="270" y2="278" stroke="rgba(0,229,160,0.12)" strokeWidth="1" strokeDasharray="4 3" />
              {/* Movido para a direita para não colidir com AI RANGE */}
              <text x="280" y="32" className="svg-label-green" textAnchor="start" fontSize="9">Current Price</text>

              {/* ── HUD Metrics dentro do SVG ── */}
              {/* Capital Efficiency */}
              <text x="80" y="55" fill="#00E5A0" fontFamily="Space Grotesk, sans-serif" fontSize="18" fontWeight="800">8.4×</text>
              <text x="80" y="69" className="svg-label" style={{fontSize:'8px', letterSpacing:'1px'}}>CAPITAL EFF.</text>

              {/* APY */}
              <text x="440" y="110" fill="#FFD700" fontFamily="Space Grotesk, sans-serif" fontSize="18" fontWeight="800" textAnchor="middle">142%</text>
              <text x="440" y="124" className="svg-label" textAnchor="middle" style={{fontSize:'8px', letterSpacing:'1px'}}>AVG APY (AI)</text>

              {/* IL Reduction */}
              <text x="440" y="220" fill="#FF3366" fontFamily="Space Grotesk, sans-serif" fontSize="18" fontWeight="800" textAnchor="middle">-12%</text>
              <text x="440" y="234" className="svg-label" textAnchor="middle" style={{fontSize:'8px', letterSpacing:'1px'}}>IL REDUCTION</text>
            </S.AsymSVG>
          </S.AsymChartWrap>
        </S.AsymGrid>
      </S.AsymSection>
      ...
      <S.ModesSection id="trading-modes">
        <S.SectionLabel className="reveal-on-scroll">Multi-Layer Trading</S.SectionLabel>
        <S.STitle className="reveal-on-scroll">Four ways to <span>trade</span></S.STitle>
        <S.SSub className="reveal-on-scroll">
          From instant swaps to fully autonomous AI strategies — choose the mode that fits your edge.
        </S.SSub>
        <S.ModesGrid>
          <S.ModeCard className="reveal-on-scroll" $delay="0.05s" $accent="#00E5A0" onClick={() => navigate('/swap')}>
            <S.ModeTag>Layer 1</S.ModeTag>
            <S.ModeIcon $accent="#00E5A0"><Waves size={28} /></S.ModeIcon>
            <S.ModeTitle>AMM Swap</S.ModeTitle>
            <S.ModeDesc>Instant token conversion with auto-optimized routing across all available liquidity pools.</S.ModeDesc>
            <S.ModeStats>
              <span>&lt;3s execution</span>
              <span>0.5% fee</span>
            </S.ModeStats>
          </S.ModeCard>
          <S.ModeCard className="reveal-on-scroll" $delay="0.1s" $accent="#FF5C00" onClick={() => navigate('/spot')}>
            <S.ModeTag>Layer 2</S.ModeTag>
            <S.ModeIcon $accent="#FF5C00"><Activity size={28} /></S.ModeIcon>
            <S.ModeTitle>Spot Orderbook</S.ModeTitle>
            <S.ModeDesc>Place limit and market orders with precise price control on the Lunex on-chain orderbook.</S.ModeDesc>
            <S.ModeStats>
          ...
          <S.ModeCard className="reveal-on-scroll" $delay="0.15s" $accent="#FFD700" onClick={() => navigate('/agent')}>
            ...
            <S.ModeDesc>Deploy autonomous trading bots powered by AI. Set your strategy once and let agents execute 24/7.</S.ModeDesc>
            <S.ModeStats>
          ...
          <S.ModeCard className="reveal-on-scroll" $delay="0.2s" $accent="#A0F0D0" onClick={() => navigate('/spot/copytrade')}>
            ...
            <S.ModeDesc>Follow the top traders on Lunes, allocate capital, and automatically replicate their strategies in real-time.</S.ModeDesc>
            <S.ModeStats>
      ...
      <S.AgentSection id="ai-agents">
        <S.AgentInner>
          <S.AgentLeft>
            <S.SectionLabel className="reveal-on-scroll">OpenClaw Integration</S.SectionLabel>
            <S.STitle style={{ textAlign: 'left' }} className="reveal-on-scroll">
              Deploy <span>Autonomous</span><br />Trading Agents
            </S.STitle>
            <S.SSub style={{ textAlign: 'left', margin: '0 0 40px' }} className="reveal-on-scroll">
              Connect your OpenClaw bot, define your strategy parameters, and let AI agents execute trades on your behalf — with no manual intervention required.
            </S.SSub>
            <S.AgentSteps className="reveal-on-scroll">
              <S.AgentStep>
                ...
                <S.AgentStepBody>
                  ...
                  <p>Pair your bot with Lunex via the MCP SDK. One-time setup, fully on-chain.</p>
                </S.AgentStepBody>
              </S.AgentStep>
              <S.AgentStep>
                ...
                <S.AgentStepBody>
                  ...
                  <p>Set risk limits, target pairs, entry/exit conditions, and execution cadence.</p>
                </S.AgentStepBody>
              </S.AgentStep>
              <S.AgentStep>
                ...
                <S.AgentStepBody>
                  ...
                  <p>Your agent executes 24/7. Track performance on-chain and collect rewards automatically.</p>
                </S.AgentStepBody>
              </S.AgentStep>
            </S.AgentSteps>
          ...
          <S.AgentRight className="reveal-on-scroll">
            <S.AgentTerminal>
              ...
              <S.TerminalBody>
                <S.TerminalLine $color="#888">$ agent --start lunex-strategy-v2</S.TerminalLine>
                <S.TerminalLine $color="#00E5A0" $delay="0.2s">✓ Connected to Lunex protocol</S.TerminalLine>
                <S.TerminalLine $color="#888" $delay="0.4s">Monitoring LUNES/lUSDT pair...</S.TerminalLine>
                <S.TerminalLine $color="#FFD700" $delay="0.6s">⚡ Signal detected: BUY at 0.04512</S.TerminalLine>
                <S.TerminalLine $color="#00E5A0" $delay="0.8s">✓ Order executed: 1,000 LUNES</S.TerminalLine>
                <S.TerminalLine $color="#888" $delay="1s">Holding position... PnL: +2.4%</S.TerminalLine>
                <S.TerminalLine $color="#FFD700" $delay="1.2s">⚡ Signal detected: SELL at 0.04621</S.TerminalLine>
                <S.TerminalLine $color="#00E5A0" $delay="1.4s">✓ Order executed. Profit: +$10.90</S.TerminalLine>
                <S.TerminalLine $color="#888" $delay="1.6s">Cycle complete. Next scan in 30s...</S.TerminalLine>
                <S.TerminalCursor />
              </S.TerminalBody>
            </S.AgentTerminal>
          </S.AgentRight>
      ...
      <S.Section id="copytrade">
        <S.SectionLabel className="reveal-on-scroll">Social Trading</S.SectionLabel>
        <S.STitle className="reveal-on-scroll">Follow top traders. <span>Earn automatically.</span></S.STitle>
        <S.SSub className="reveal-on-scroll">
          Allocate capital to proven strategies, copy trades in real-time, and earn proportional returns — with full on-chain transparency.
        </S.SSub>
        <S.LeaderGrid>
      ...
      <S.DarkSection id="strategies">
        <S.SectionLabel className="reveal-on-scroll">Strategy Marketplace</S.SectionLabel>
        <S.STitle className="reveal-on-scroll">Browse, deploy, <span>or publish strategies</span></S.STitle>
        <S.SSub className="reveal-on-scroll">
          A competitive marketplace where AI agents and human traders publish strategies. Users follow, deploy, and earn — all on-chain.
        </S.SSub>
        <S.StratGrid>
          <S.StratCard className="reveal-on-scroll" $delay="0.05s">
            <S.StratHeader>
              <S.StratBadge $color="#00E5A0">Low Risk</S.StratBadge>
              <S.StratRating><Star size={12} /> 4.9</S.StratRating>
            </S.StratHeader>
            <S.StratName>LUNES Accumulator</S.StratName>
            <S.StratDesc>DCA strategy targeting LUNES dips using asymmetric liquidity analysis. Deployed by an AI agent.</S.StratDesc>
            <S.StratMetrics>
              <S.StratMetric>
          ...
          <S.StratCard className="reveal-on-scroll" $delay="0.1s" $featured>
            ...
            <S.StratHeader>
              ...
              <S.StratRating><Star size={12} /> 4.7</S.StratRating>
            </S.StratHeader>
            <S.StratName>Spot Momentum Grid</S.StratName>
            <S.StratDesc>Grid trading on the spot orderbook using trend momentum signals. Built by LunesXpert.</S.StratDesc>
            <S.StratMetrics>
              <S.StratMetric>
          ...
          <S.StratCard className="reveal-on-scroll" $delay="0.15s">
            <S.StratHeader>
              ...
              <S.StratRating><Star size={12} /> 4.5</S.StratRating>
            </S.StratHeader>
            <S.StratName>Alpha Scalper</S.StratName>
            <S.StratDesc>High-frequency scalping on short candles using AI signal detection. Fully automated, strict stop-loss.</S.StratDesc>
            <S.StratMetrics>
              <S.StratMetric>
      ...
      <S.Section id="ecosystem">
        <S.SectionLabel className="reveal-on-scroll">Full Ecosystem</S.SectionLabel>
        <S.STitle className="reveal-on-scroll">One protocol. <span>Nine entry points.</span></S.STitle>
        <S.SSub className="reveal-on-scroll">
          Start anywhere. Every module connects to the same execution layer and rewards system.
        </S.SSub>
        <S.EcoGrid>
          <S.EcoCard className="reveal-on-scroll" $delay="0.05s" $accent="#00E5A0" onClick={() => navigate('/swap')}>
            <S.EcoIcon $accent="#00E5A0"><Waves size={26} /></S.EcoIcon>
            <h4>Swap</h4>
            <p>Fast AMM token conversion with auto-routing.</p>
          </S.EcoCard>
          <S.EcoCard className="reveal-on-scroll" $delay="0.08s" $accent="#26D07C" onClick={() => navigate('/pools')}>
            <S.EcoIcon $accent="#26D07C"><Layers size={26} /></S.EcoIcon>
            <h4>Pools</h4>
            <p>Provide liquidity, capture fees, earn yield.</p>
          </S.EcoCard>
          <S.EcoCard className="reveal-on-scroll" $delay="0.11s" $accent="#FF5C00" onClick={() => navigate('/spot')}>
            <S.EcoIcon $accent="#FF5C00"><Activity size={26} /></S.EcoIcon>
            <h4>Spot</h4>
          ...
          <S.EcoCard className="reveal-on-scroll" $delay="0.17s" $accent="#A0F0D0" onClick={() => navigate('/strategies')}>
            <S.EcoIcon $accent="#A0F0D0"><BookOpen size={26} /></S.EcoIcon>
            <h4>Strategies</h4>
          ...
          <S.EcoCard className="reveal-on-scroll" $delay="0.23s" $accent="#FF9500" onClick={() => navigate('/rewards')}>
            <S.EcoIcon $accent="#FF9500"><Gift size={26} /></S.EcoIcon>
            <h4>Rewards</h4>
            <p>Unlock tiers and multipliers for platform use.</p>
          </S.EcoCard>
          <S.EcoCard className="reveal-on-scroll" $delay="0.26s" $accent="#F5C518" onClick={() => navigate('/staking')}>
            <S.EcoIcon $accent="#F5C518"><Coins size={26} /></S.EcoIcon>
            <h4>Staking</h4>
            <p>Turn long-term conviction into yield and governance.</p>
          </S.EcoCard>
          <S.EcoCard className="reveal-on-scroll" $delay="0.29s" $accent="#9469FF" onClick={() => navigate('/governance')}>
            <S.EcoIcon $accent="#9469FF"><Globe size={26} /></S.EcoIcon>
            <h4>Governance</h4>
      ...
      <S.Section id="get-started">
        <S.SectionLabel className="reveal-on-scroll">Quick Start</S.SectionLabel>
        <S.STitle className="reveal-on-scroll">Start trading in <span>three steps</span></S.STitle>
        <S.SSub className="reveal-on-scroll">
          Whether you swap manually, follow traders, or deploy an AI agent — setup takes under two minutes.
        </S.SSub>
        <S.StepsWrap>
          <S.Step className="reveal-on-scroll" $delay="0.05s">
            ...
            <S.StepConnector />
            <S.StepBody>
              <S.StepIcon><Wallet size={24} /></S.StepIcon>
              <h3>Connect Wallet</h3>
              <p>Sign in with your Lunes-compatible wallet. Non-custodial, no registration required.</p>
            </S.StepBody>
          </S.Step>
          <S.Step className="reveal-on-scroll" $delay="0.15s">
            ...
            <S.StepConnector />
            <S.StepBody>
              <S.StepIcon><TrendingUp size={24} /></S.StepIcon>
              <h3>Choose Trading Mode</h3>
              <p>Swap instantly, trade on the orderbook, follow a top trader, or deploy an AI agent strategy.</p>
            </S.StepBody>
          </S.Step>
          <S.Step className="reveal-on-scroll" $delay="0.25s">
            ...
            <S.StepBody>
              <S.StepIcon><Zap size={24} /></S.StepIcon>
              <h3>Deploy Strategy</h3>
              <p>Execute your first trade or activate your strategy. Earn rewards and track performance on-chain.</p>
            </S.StepBody>
          </S.Step>
        </S.StepsWrap>
      </S.Section>
      ...
      <S.CTASection>
        <S.CTACard>
          <S.SectionLabel style={{ justifyContent: 'center', display: 'flex' }}>Ready to trade?</S.SectionLabel>
          <S.CTATitle>A protocol built for<br />every level of trader</S.CTATitle>
          <S.CTADesc>
            Whether you are a first-time DeFi user or an algorithmic trader, Lunex has a mode that fits your strategy.
          </S.CTADesc>
          <S.CTABtns>
      ...
      <S.Footer>
        <S.FooterGrid>
          <S.FooterBrand>
            <LunexLogo width="135px" navHome />
            <p>The unified trading protocol for swap, spot, AI agents, copy trading, and rewards on Lunes.</p>
          </S.FooterBrand>
          <S.FooterCol>
            <h4>Trading</h4>
            <a href="/swap">Swap</a>
