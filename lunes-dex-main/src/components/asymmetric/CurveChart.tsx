...
function buildChartData(buyParams: CurveParams, sellParams: CurveParams, steps = 50) {
...
const CurveChart: React.FC<Props> = ({
    ...
    const dragRef = useRef<{ startY: number; side: 'buy' | 'sell'; startGamma: number } | null>(null)
    ...
    const handleMouseMove = useCallback((e: React.MouseEvent) => {
        ...
        const clampedGamma = Math.round(Math.max(1, Math.min(5, rawGamma)) * 10) / 10
            ...
            <ResponsiveContainer width="100%" height={220}>
                <AreaChart data={data} margin={{ top: 4, right: 8, left: 0, bottom: 0 }}>
                    ...
                    <XAxis
                        ...
                        tickLine={false}
                        axisLine={false}
                        label={{ value: 'Volume', position: 'insideBottomRight', offset: -8, fill: '#6b7280', fontSize: 11 }}
                    />
                    ...
                    <YAxis
                        ...
                        tickLine={false}
                        axisLine={false}
                        label={{ value: 'Liquidity', angle: -90, position: 'insideLeft', offset: 8, fill: '#6b7280', fontSize: 11 }}
                    />
