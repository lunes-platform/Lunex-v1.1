...
const CopyBtn = styled.button<{ copied?: boolean }>`
  background: ${({ copied }) => copied ? 'rgba(0, 192, 118, 0.15)' : 'rgba(108, 56, 255, 0.15)'};
  border: 1px solid ${({ copied }) => copied ? 'rgba(0, 192, 118, 0.3)' : 'rgba(108, 56, 255, 0.3)'};
  border-radius: 8px;
  padding: 6px 14px;
  font-size: 12px;
  font-weight: 600;
  ...
  &:hover {
    background: ${({ copied }) => copied ? 'rgba(0, 192, 118, 0.2)' : 'rgba(108, 56, 255, 0.25)'};
  }
`
  ...
  return (
    <Overlay onClick={onClose}>
      <Modal onClick={e => e.stopPropagation()}>
        ...
        <MessagePreview>
          <strong style={{ color: 'rgba(255,255,255,0.65)' }}>Preview:</strong><br />
          {shareMessage}
        </MessagePreview>
      </Modal>
    </Overlay>
