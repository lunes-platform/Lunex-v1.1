...
const MAX_SUPPLY = 6_000_000_000 // 6 billion LUNES total max supply
...
const ActionsWrapper = styled.div`
  ...
  gap: 8px;
  align-items: center;
  margin-left: auto; /* Empurra para a direita absoluta do container */
`
...
const PriceHeader: React.FC = () => {
  const { ticker, orderbook } = useSpot()
  ...
  // Fetch circulating supply from on-chain WLUNES totalSupply
  useEffect(() => {
  ...
  // Compute buy/sell pressure from orderbook
