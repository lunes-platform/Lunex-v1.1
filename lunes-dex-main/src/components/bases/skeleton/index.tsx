...
export const SkeletonBox: React.FC<{ width?: string; height?: string; radius?: string }> = ({ width, height, radius }) => (
    ...
    <CardSkeletonWrapper>
        <Row>
            ...
            <div style={{ flex: 1 }}>
                ...
                <SkeletonBase $width="40%" $height="14px" $radius="6px" style={{ marginTop: '8px' }} />
            </div>
        </Row>
        <SkeletonBase $width="100%" $height="40px" $radius="6px" style={{ marginBottom: '16px' }} />
