...
export class HttpClient {
    ...
    constructor(config: LunexConfig) {
        ...
        this.instance.interceptors.request.use(
            (config) => {
                const lunexOptions = (config as AxiosConfigWithLunexOptions).lunexOptions;
    ...
    async get<T>(url: string, params?: unknown, options?: HttpRequestOptions): Promise<T> {
    ...
    async delete<T>(url: string, params?: unknown, options?: HttpRequestOptions): Promise<T> {
